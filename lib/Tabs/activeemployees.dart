...
class activeemployeesUI extends StatefulWidget {
  @override
  State<activeemployeesUI> createState() => _activeemployeesUIState();
}

class _activeemployeesUIState extends State<activeemployeesUI> {
  late Query _ref;
  ...
  Widget _buildContactItem({Map? employee}) {
    Color statusColor =
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: FirebaseAnimatedList(
        query: _ref.equalTo("Active"),
        itemBuilder: (BuildContext context, DataSnapshot snapshot,
            Animation<double> animation, int index) {
          Map employee = snapshot.value as Map;
          return _buildContactItem(employee: employee);
        },
      ),
    );
  }
